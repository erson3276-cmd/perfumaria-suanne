    ...
    <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
      ...
      <div className="relative">
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 px-6 py-10 sm:px-12 sm:py-14">
                      ...
                      <span className="mt-6 inline-flex items-center gap-2 border border-gold/60 bg-ink/40 px-5 py-2.5 text-xs uppercase tracking-[0.2em] text-gold-pale backdrop-blur-sm transition-colors group-hover:bg-gold group-hover:text-ivory">
                        Ver todos
        ...
        <button
          ...
          aria-label="Anterior"
          className="absolute -left-2 top-1/3 hidden h-12 w-12 -translate-y-1/2 items-center justify-center border border-gold/40 bg-ivory text-ink transition-colors hover:bg-gold hover:text-ivory lg:flex"
        >
        ...
        <button
          ...
          aria-label="Próximo"
          className="absolute -right-2 top-1/3 hidden h-12 w-12 -translate-y-1/2 items-center justify-center border border-gold/40 bg-ivory text-ink transition-colors hover:bg-gold hover:text-ivory lg:flex"
        >
